...
export class PharmacistPage extends Component {
    ...
    render() {
        ...
        let Press = this.props.prescriptions.map (x=> {return(
            {patient:x.patientId,
            drugName:x.drugName,
            duration:x.duration}
...
//        let patientId = this.state.patientId,
        ...
        if (this.state.selectPrescription=true) {
            var PrescriptionList = Press.map((l)=> {
                return (
                <div>
                    <li className='form-control'>{l.patient}</li>
                    <li className='form-control'>{l.drugName}</li>
                    <li className='form-control'>{l.duration}</li>
                    ...
                    <form className='form-inline'>
                        ...
                        <div className="card-body">
                            <div className='card text-center' style={{ minWidth: '30%', marginRight:'5%', marginLeft:'5%' }}>
                                <h5 className="card-header">Doctor Name</h5>
